  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-100 select-none overflow-hidden relative">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {/* Card 3.5: Cloudflare Database Sync and Custom Domain configuration */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xs overflow-hidden p-5 space-y-4 text-left">
          <div className="flex items-center space-x-2 pb-2 border-b border-gray-50">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-bold text-gray-800">🌐 Cloudflare 极速互联中继</h3>
              <p className="text-[10px] text-gray-400">一键切换代驾多端实时数据至 Cloudflare 自定义域名运行</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">
                您的自定义域名或 Worker 终端地址
              </label>
              <div className="flex gap-2">
                <div className="flex-1 relative flex items-center bg-slate-50 border border-slate-200 focus-within:bg-white rounded-xl px-3 py-2.5 transition-all">
                  <input
                    type="text"
                    value={cloudflareUrl}
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#1da39b] hover:bg-teal-600 disabled:bg-slate-300 text-white font-bold text-xs rounded-xl transition-all shadow-sm flex items-center gap-1.5 cursor-pointer shrink-0"
                >
                  {testingConnection ? (
            ...
            <div className="bg-orange-50/65 border border-orange-100 rounded-xl p-3.5 text-[11px] text-slate-600 space-y-1.5 leading-relaxed">
